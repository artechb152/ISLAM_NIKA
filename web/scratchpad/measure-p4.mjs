...
await page.goto('http://localhost:3000/chapter1/dev-character?model=%2Fassets%2Fchapter1%2Fmodels%2Fplayer4.glb&raw=1', { waitUntil: 'domcontentloaded' })
...
await page.screenshot({ path: `scratchpad/committee-r0/p4-${clip}.png` })
await browser.close()
