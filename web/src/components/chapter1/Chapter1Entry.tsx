    ...
    <div className="chapter-page p1-open">
      ...
      <main className="p1-open-stage" aria-labelledby="p1-open-title">
        ...
        <div className="p1-open-copy">
          ...
          {/* ── שורה אחת של הסבר, ולמה היא כאן ─────────────────────────
              המרצה כתבה על הפרק „לא הצלחתי לנווט מספיק טוב במשחק ההוא".
              מסך הפתיחה הוא המקום היחיד שבו אפשר לומר את זה לפני שמישהו
              עומד במדבר ולא יודע מה לעשות — ושלוש הפקודות האלה הן כל מה
              שצריך כדי לזוז, להסתכל ולפעול. לוח המקשים המלא נשאר פתוח
              בתוך המשחק, וזו התזכורת ולא התחליף. השורה קטנה ושקטה
              בכוונה: המסך נשאר מסך אחד עם כותרת ולחצן. */}
          <p className="p1-open-keys">
            שמונה תחנות בדרך אל מכה
            <span aria-hidden="true"> · </span>
            הליכה <kbd>W</kbd><kbd>A</kbd><kbd>S</kbd><kbd>D</kbd>
            <span aria-hidden="true"> · </span>
            מבט — גרירת עכבר
            <span aria-hidden="true"> · </span>
            פעולה — <kbd>E</kbd>
