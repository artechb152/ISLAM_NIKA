    ...
    <div className="ch1-find" role="dialog" aria-labelledby="ch1-find-title">
      <div className="ch1-find-card">
        ...
        {/* העדות עצמה, ביד: הדגם שכבר שכב על הקרקע מסתובב מול העיניים,
            וגרירה מסובבת אותו — רואים את הדף משני צדדיו במקום לקרוא עליו */}
        <FindView model={find.model} />
        <p className="ch1-find-body">{find.body}</p>
        {/* ── מי מסר, ומתי ──────────────────────────────────────────
            הכרטיס אמר עד כה מה כתוב במקור ולא מי כתב אותו, ולכן הוא
            לימד עובדות ולא קריאה של מקור. §1 קובע שרוב מה שידוע מגיע
            מן המסורת המוסלמית ויש לקחתו ב„עירבון מוגבל"; שורה אחת כאן,
            על כל מקור בנפרד, היא הדרך היחידה שזה נעשה בה משהו. */}
        <p className="ch1-find-sourcing"><b>מי מסר את זה?</b> {find.sourcing}</p>
