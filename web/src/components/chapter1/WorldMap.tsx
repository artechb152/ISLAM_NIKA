  ...
  return (
    ...
    >
      ...
      <div className="map-plate" style={{ aspectRatio: MAP_ASPECT }}>
        ...
        {/* „דרך הבשמים" אינה בחוברת אף לא פעם אחת — הכותרת אומרת עכשיו
            את מה שהיא כן אומרת: נדידה צפונה מאזור תימן, לאורך נתיבי
            הסחר שהשבטים שמרו עליהם (§7). */}
        <div className="map-title">
          <h2>הדרך צפונה</h2>
          <p>מאזור תימן, לאורך נתיבי הסחר — ובחזרה דרומה אל מכה</p>
        </div>
