/* Chapter 2 content access.
   ...
   of that:
     ...
     · "every sentence appears exactly once" becomes checkable, because
       concept/chapter3/verify-chapter3.mjs can diff the fragments that exist
       against the fragments layout.json consumes.

   Nothing here may be edited to change wording. Edit concept/chapter3/SOURCE-TEXT.md
...
export interface Fragment {
  ...
  /** An APPROVED REWORDING, printed instead of `text`.
      ...
      verify-chapter3.mjs lists every `page` it finds so the count can never sit
