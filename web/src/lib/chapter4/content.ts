/* Chapter 4 content access.
   ...
   of that:
     ...
     · "every sentence appears exactly once" becomes checkable, because
       concept/chapter4/verify-chapter4.mjs can diff the fragments that exist
       against the fragments layout.json consumes.

   Nothing here may be edited to change wording. Edit concept/chapter4/SOURCE-TEXT.md
...
export interface Fragment {
  ...
  /** An APPROVED REWORDING, printed instead of `text`.
      ...
      verify-chapter4.mjs lists every `page` it finds so the count can never sit
