...
export const FINDS: Find[] = [
  /* ---- מחנה הלילה — where the road starts, and Rawi's own region ----

     האבן עברה לכאן כשרמות תימן אוחדה לתוך המחנה. היא אינה עוד „בקצה
     טרסה" אלא בשולי המחנה עצמו, וזה המקום הנכון לה: כתובות ערביות
     קדומות נחרתו בעצירות לילה ובבארות, בידי מי שלן שם.

     שבר הכד של תימן (`find-yemen-sherd`) לא עבר — במחנה כבר יש שבר כד
     ליד הבאר, ו-§7 שהוא נשא נאמר כאן בצרור הלבונה ובשורת הפתיחה. */
  {
    id: 'find-terrace-inscription',
    region: 'night-camp',
    x: -2, z: 0, model: 'find-inscription', h: 0.8, ry: 0.4,
    title: 'כתובת חרותה באבן',
    body:
      'אותיות חרוטות באבן לצד הדרך, בשולי המחנה. מי שחרט אותן עמד כאן וחרט אותן בזמנן — האבן אינה מוסרת ' +
      'דבר בשמו של מישהו אחר, וכתובת כזאת נדירה. רוב מה שידוע לנו על חצי האי ערב לפני ' +
      'האסלאם הגיע בדרך השנייה: מהספרות ומהמסורת המוסלמית, שנכתבו הרבה אחרי אותם ימים.',
    source: '§1',
  },
  {
    id: 'find-camp-sherd',
    ...
    body:
      'שברי חרס נטושים ליד הבאר. אלה חיי היום־יום של התקופה שתיקרא ג׳אהליה — תקופת ' +
      'הבערות: באר, מחנה, כדים שנשברו ונזרקו. השם הגדול ניתן לה רק אחר כך.',
    source: '§0',
  },
  {
  ...
  },
  {
    ...
    title: 'אבן ניצבת',
    body:
      'אבן בלתי מסותתת שהוצבה על כן. אבנים כאלה ניצבו בכל חצי האי, ולכל אחת היה מי ' +
      'שהיא שייכת לו — עבודת האלילים הייתה כאן חזון נפרץ.',
    source: '§33',
  },
  {
    id: 'find-mecca-coin',
