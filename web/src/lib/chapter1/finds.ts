...
export const FINDS: Find[] = [
  /* ---- מחנה הלילה — ומה בכלל יודעים, ומאיפה ---- */
  {
    ...
    title: 'דף מן המסורת המוסלמית',
    body:
      'דף מועתק, מונח על האוכף. המידע על החיים בחצי האי ערב לפני האסלאם דל, ' +
      'ומרביתו ידוע לנו מן הספרות ומן המסורת המוסלמית.',
    sourcing:
      'מי כתב את זה, ומתי? מוסלמים, דורות אחרי התקופה שהם מתארים. לכן במבט ביקורתי ' +
