...
export const FINDS: Find[] = [
  /* ---- רמות תימן — where the road starts, and where the terraces are ---- */
  {
    ...
    body:
      'אותיות חרוטות בקצה טרסה. מי שחרט אותן עמד כאן וחרט אותן בזמנן — האבן אינה מוסרת ' +
  ...
  },
  {
    id: 'find-yemen-sherd',
    region: 'yemen-heights',
    /* היה בתוך קטע הקיר היבש ב-(6.6,-6.5) — שבר חרס שמוטמע באבן
       אינו שבר חרס שנשכח על החול. שני מטרים החוצה, אל השטח הפתוח. */
    x: 9.6, z: -7.4, model: 'find-sherd', h: 0.16, ry: 1.1,
    title: 'שברי כד',
    body:
