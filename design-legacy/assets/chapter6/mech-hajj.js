/* החג'.
   ...
   map and one check for this commandment; the map and the check live in mech-checks.js and
   the seven screens are plain reading screens. None of these ids appear in data.js, so the
