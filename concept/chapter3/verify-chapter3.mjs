/* Chapter 3 fidelity gate. Three invariants, all machine-checked:
   ...
   Run: node concept/chapter3/verify-chapter3.mjs
*/
import { readFile } from 'node:fs/promises'

const here = new URL('.', import.meta.url)
const src = await readFile(new URL('SOURCE-TEXT.md', here), 'utf8')
const data = JSON.parse(await readFile(new URL('../../web/src/lib/chapter3/passages.json', here), 'utf8'))

let layout = null
try {
  layout = JSON.parse(await readFile(new URL('../../web/src/lib/chapter3/layout.json', here), 'utf8'))
} catch {
